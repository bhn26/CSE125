...
void ServerGame::receiveMovePacket(int offset)
{
	...
	if (player->GetJumpSem())
	{
		switch (pi->direction) {
		case MOVE_FORWARD:
			vec = new btVector3(0, 0, (player->GetPlayerSpeed()));
			ent->Move(vec);
			delete vec;
			break;
		case MOVE_BACKWARD:
			...
			break;
		case MOVE_LEFT:
			vec = new btVector3((player->GetPlayerSpeed()), 0, 0);
			ent->Move(vec);
			delete vec;
			break;
		case MOVE_RIGHT:
	...
	else
	{
		switch (pi->direction) {
		case MOVE_FORWARD:
			vec = new btVector3(0, -6, (player->GetPlayerSpeed()));
			ent->Move(vec);
			delete vec;
			break;
		case MOVE_BACKWARD:
			...
			break;
		case MOVE_LEFT:
			vec = new btVector3((player->GetPlayerSpeed()), -6, 0);
			ent->Move(vec);
			delete vec;
			break;
		case MOVE_RIGHT:
