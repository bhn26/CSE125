...
namespace Animation
{
    ...
    public:
        ...
        bool FBXLoadClean(std::string filename, bool animLoops = false);            // Loads both Mesh and Animation
        bool AddAnimation(std::string animationFile, bool loops = false);   // Only loads Animation
